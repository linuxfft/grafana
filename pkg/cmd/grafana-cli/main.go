...
import (
	...
	"github.com/masami10/grafana/pkg/cmd/grafana-cli/commands"
	"github.com/masami10/grafana/pkg/cmd/grafana-cli/logger"
	"github.com/masami10/grafana/pkg/cmd/grafana-cli/services"
	"github.com/masami10/grafana/pkg/cmd/grafana-cli/utils"
)
...
func main() {
	...
	app.Email = "https://github.com/masami10/grafana"
	app.Version = version
	app.Flags = []cli.Flag{
		cli.StringFlag{
			Name:   "pluginsDir",
